...
<head>
  ...
  <title>아이 프로필 등록 - LittleSteps</title>
  <style>
...
<div class="wrap">
  <p class="nav"><a href="/usr/child/list">아이 프로필 관리</a> &gt; 등록</p>
  ...
  <div class="card">
    ...
    <form method="post" action="/usr/child/doWrite">
      <div class="field">
        ...
        <input type="text" name="name" placeholder="아이 이름을 입력해 주세요." required />
      </div>
      <div class="field">
        <label>생년월일</label>
      ...
      <div class="field">
        <label>메모</label>
        <textarea name="note" placeholder="특이사항 등 간단히 입력해 주세요."></textarea>
      </div>
      <div class="btns">
